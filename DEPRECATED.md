# Former name: `hermesbenchv0_1`

GitHub may redirect `https://github.com/am423/hermesbenchv0_1` to this repository (`hermes-bench-tool-call`). They are the **same project** (repo id 1257488099).

Use this clone URL going forward:
